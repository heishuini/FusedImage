...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        # default=['datasets/DIV2K_HR', 'datasets/DIV2K_multiscale'],
        # default=['./crop_val_HR_1024'],
        # default=['./cropped_512/DIV2K_HR',  # 800
    ...
    parser.add_argument(
        '--meta_info',
        type=str,
        # default='datasets/meta_info/meta_info_DIV2K_HR_multiscale.txt',
        default='./cropped_DIV2K_VAL.txt',
