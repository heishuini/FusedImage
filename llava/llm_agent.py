...
class LLavaAgent:
    def __init__(self, model_path, device='cuda', conv_mode='vicuna_v1', load_8bit=False, load_4bit=True):
        ...
        # self.qs = 'Using 50–60 words,according to the degradation of the image, give a prompt to guide the restoration, do not have degradation-related words, pay attention to detail and fidelity.'
